...
/*=======================================================================================================================================*/
				...
				$where = array('id' => $id);
				$this->data['name'] = $this->catalog_model->get_info_rule($where,'name');
				$input['where'] = array('catalog_id' => $id);
            	$prod_cat = $this->product_model->get_list($input);
				$this->data['list'] = $prod_cat;

				$this->data['temp'] = 'site/catalog/categories';
...
/*=======================================================================================================================================*/
				...
				$this->data['list']  = $this->catalog_model->get_list($output);

				$this->data['temp'] = 'site/catalog/categories_parent';
				$this->load->view('site/layout',$this->data);
...
/*=======================================================================================================================================*/
				...
				$this->data['temp'] = 'site/catalog/brand';
				$this->load->view('site/layout',$this->data);
		...
		{	
			...
			$this->data['size'] = $size[$key_color];
			$this->load->view('site/ajax/product_size',$this->data);
		}
	}
?>