...
class Express_checkout extends MY_Controller
{
	...
	public function OrderComplete()
	{
		...
		$transaction['fee'] = $shopping_cart['paypal_fee'];
		$transaction['amount'] = $shopping_cart['shopping_cart']['grand_total'];
	...
	public function OrderCancelled()
	{
		...
		$this->session->set_flashdata('notify',$this->lang->line('pay-error'));
		redirect(base_url());
	}
