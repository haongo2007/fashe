...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Create Static Page With Gjs</title>
    <meta content="Best Free Open Source Responsive Websites Builder" name="description">
    <link rel="stylesheet" href="<?php echo public_url('admin/gjs/stylesheets') ?>/toastr.min.css">
    <link rel="stylesheet" href="<?php echo public_url('admin/gjs/stylesheets') ?>/grapes.min.css?v0.14.57">
    <link rel="stylesheet" href="<?php echo public_url('admin/gjs/stylesheets') ?>/grapesjs-preset-webpage.min.css">
    <link rel="stylesheet" href="<?php echo public_url('admin/gjs/stylesheets') ?>/tooltip.css">
    <link rel="stylesheet" href="<?php echo public_url('admin/gjs/stylesheets') ?>/grapesjs-plugin-filestack.css">
    <link rel="stylesheet" href="<?php echo public_url('admin/gjs/stylesheets') ?>/demos.css">
    ...
    <script src="<?php echo public_url('admin/gjs/js') ?>/toastr.min.js"></script>

    <script src="<?php echo public_url('admin/gjs/js') ?>/grapes.min.js?v0.14.57"></script>
    <script src="<?php echo public_url('admin/gjs/js') ?>/grapesjs-preset-webpage.min.js"></script>
    <script src="<?php echo public_url('admin/gjs/js') ?>/grapesjs-lory-slider.min.js?0.1.5"></script>
    <script src="<?php echo public_url('admin/gjs/js') ?>/grapesjs-tabs.min.js?0.1.1"></script>
    <script src="<?php echo public_url('admin/gjs/js') ?>/grapesjs-custom-code.min.js?0.1.1"></script>
    <script src="<?php echo public_url('admin/gjs/js') ?>/grapesjs-touch.min.js?0.1.1"></script>
    <script src="<?php echo public_url('admin/gjs/js') ?>/grapesjs-parser-postcss.min.js?0.1.1"></script>
    <script src="<?php echo public_url('admin/gjs/js') ?>/grapesjs-tooltip.min.js?0.1.1"></script>
    <script src="<?php echo public_url('admin/gjs/js') ?>/grapesjs-tui-image-editor.min.js?0.1.2"></script>
  ...
  <body>
    <div style="display: none">
      <div class="gjs-logo-cont">
        <a href="//grapesjs.com"><img class="gjs-logo" src="<?php echo public_url('admin/gjs/img') ?>/grapesjs-logo-cl.png"></a>
      ...
      <section class="am-sect">
        <div class="container-width">
          <div class="am-container">
            <img class="img-phone" onmousedown="return false" src="<?php echo public_url('admin/gjs/img') ?>/phone-app.png"/>
        ...
        <div class="container-width">
          ...
          <div class="badges">
            <div class="badge">
              ...
              <img class="badge-avatar" src="<?php echo public_url('admin/gjs/img/') ?>team1.jpg">
            ...
            <div class="badge">
              <div class="badge-header"></div>
              <img class="badge-avatar" src="<?php echo public_url('admin/gjs/img/') ?>team2.jpg">
              <div class="badge-body">
            ...
            <div class="badge">
              <div class="badge-header"></div>
              <img class="badge-avatar" src="<?php echo public_url('admin/gjs/img/') ?>team3.jpg">
              <div class="badge-body">
    ...
    <div class="path" data-path="<?php echo public_url('admin/gjs/img/') ?>"></div>
    	<div class="form-sub" id="form_send" style="display: none;text-align: center;">
    		<label>Tên</label>
        <input class="sub-input name" placeholder="Name" />
        <label>Status</label>
        <input type="checkbox" class="sub-input status" placeholder="Email"/>
        <button id="send_db" data-redi="<?php echo admin_url('page') ?>" data-url="<?php echo admin_url('page/save') ?>" class="btn btn-primary" type="button">Submit</button>
      </div>
    <script type="text/javascript">
      var lp = $('.path').attr('data-path');
      ...
      // Add the command
        ...
        var form_send = $('#form_send').css('display', 'block');
        editor.Commands.add
        ('save-db', {
            run: function(editor, sender)
            {
              ...
              editor.store();
              modal.setTitle('Lưu Database');
		        	modal.setContent(form_send);
			        modal.open();
            }
        });
      $('#send_db').click(function(event) {
      	var status = '0';
        ...
        $.ajax({
            method: "POST",
            url: url,
            data:{name:name,status:status,html:html,css:css},
