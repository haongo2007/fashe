				...
				<!-- TAB 1 -->
		     	<div id='tab1' class="tab_content pd0">
		         	<div class="formRow">
						...
						<div class="formRight">
							<span class="oneTwo">
								<input name="title" id="param_title" _autocheck="true" type="text" value="<?php echo $news->title ?>" />
							</span>
					...
					<div class="formRow">
						...
						<div class="formRight">
							<div class="left">
								...
								<img src="<?php echo base_url('upload/news/'.$news->image_link) ?>" width="100" height="70">
							</div>
					...
					<div id='tab2' class="tab_content pd0" >
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<textarea name="meta_desc" id="param_meta_desc" _autocheck="true" rows="4" cols="">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									<textarea name="meta_key" id="param_meta_key" _autocheck="true" rows="4" cols="">
