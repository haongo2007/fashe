<div class="row">
    <?php   
        echo '<h4 class="m-text20 t-center col-md-12 m-b-10">'.$this->lang->line('recently').'</h4>';
        $recentlyViewed = $this->session->userdata('recentlyViewed');
        foreach ($recentlyViewed as $row => $value ) {
    ...
    ?>
        <!-- Block2 -->
    <div class="block2 col-md-6 dis-flex m-b-20">
